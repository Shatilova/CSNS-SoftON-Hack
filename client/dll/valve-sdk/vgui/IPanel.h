...
namespace vgui {
	...
	public:
		...
		virtual void Unknown1(IPanel* vguiPanel) = 0;
		virtual void Unknown2(IPanel* vguiPanel) = 0;
		virtual void Unknown3(IPanel* vguiPanel) = 0;
		virtual void Unknown4(IPanel* vguiPanel) = 0;
		...
		virtual void Unknown5(IPanel* vguiPanel) = 0;
		virtual void Unknown6(IPanel* vguiPanel) = 0;
		virtual void Unknown7(IPanel* vguiPanel) = 0;
		virtual void Unknown8(IPanel* vguiPanel) = 0;
		virtual void Unknown9(IPanel* vguiPanel) = 0;
		...
		virtual void Unknown10(IPanel* vguiPanel) = 0;
		virtual void Unknown11(IPanel* vguiPanel) = 0;
